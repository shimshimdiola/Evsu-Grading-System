        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="../grade/grades.php" class="nav-link active">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"> <span class="text-primary font-weight-bold"> <i class="fas fa-graduation-cap"></i> GRADES</span>
                            </h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row["grade_first_semester"] ?></td>

                                                <td><?php echo $row["grade_second_semester"] ?></td>
                                                <td>
                                                    <?php
                                                    $gradeFirstSemester = $row["grade_first_semester"];
                                                    $gradeSecondSemester = $row["grade_second_semester"];



                                                    // Calculate the overall grade
                                                    $overallGrade = $gradeFirstSemester + $gradeSecondSemester / 2;

                                                    // Check if the overall grade is equal to or above 3.0
                                                    if ($overallGrade == 0.00) {
                                                        $result_grade = '<strong class="text-danger"> - FAIL</strong>';
                                                    } elseif ($overallGrade >= 3.0) {
                                                        $result_grade = '<strong class="text-danger"> - FAIL</strong>';
                                                    } elseif ($overallGrade <= 3.0) {
                                                        $result_grade = '<strong class="text-success"> - PASS</strong>';
                                                    }

                                                    echo  number_format($overallGrade, 2) . " " . $result_grade . "";
                ...
                <form action="./update_profile.php" method="post" enctype="multipart/form-data">
                    <div class="form-group text-center">
                        <div class="position-relative">
                            ...
                            <input type="file" class="form-control-file d-none" name="image" id="profilePicture" accept="image/*">
