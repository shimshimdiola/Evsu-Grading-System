                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>-</td>
                                            <td>C</td>
                                            <td><button class="mr-1 btn btn-sm btn-primary" type="submit"><i class="fas fa-edit"></i> Edit</button><button class="mr-1 btn btn-sm btn-danger swalDefaultSuccess" type="submit"><i class="fas fa-trash-alt"></i> Delate</button></td>
                ...
                <div class=" p-2 container text-center">
                    ...
                    <form>
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button class="btn btn-sm btn-success "> <i class="fas fa-upload"></i> Upload</button>
