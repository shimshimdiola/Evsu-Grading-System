                    ...
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"> <span class="text-primary font-weight-bold"> <i
                                        class="fas fa-graduation-cap"></i> ACTIVITIES</span>
                            </h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">List of students Submited the activity</h3>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM activities WHERE name = '$full_name'";
