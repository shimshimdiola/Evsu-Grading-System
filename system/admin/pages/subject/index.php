        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="../admission/index.php" class="nav-link ">
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="../subject/index.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Subjects</p>
                                    </a>
                                </li>
                        ...
                        <div class="col-md-4">
                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    <h3 class="card-title"><i class="fas fa-book-open "></i> add subject</h3>
                                ...
                                <div class="card-body text-capitalize">
                                    <div class=" callout callout-success">
                                        <p>pleas enter valid subject.</p>
                                    </div>
                                    <form action="./action.php" method="post">
                                        <div class="form-group">
                                            <label for=""> <i class="fas fa-book text-info"></i> Subject</label>
                                            <input type="text" name="subject" id="" class="form-control" required>
                                        </div>

                                        <button class="btn btn-success" type="submit" name="save_subject"><i
                                                class="fas fa-plus"></i>
                                            Add</button>
                                    </form>
                                </div>
                        ...
                        <div class="col-md-8">
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="subject" class="table table-bordered text-capitalize">
                                        <thead>
                                            <tr>
                                                <th>Subject</th>
