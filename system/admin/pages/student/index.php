               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="../student/index.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Student</p>
                                    </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    <h3 class="card-title"><i class="fas fa-folder"></i> Students</h3>
                                    ...
                                    <table id="admission" class="table table-bordered text-capitalize">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>last name</th>
                                                <th>MIddle Name</th>
                                                <th class="bg-cyan">Subject 1</th>
                                                <th class="bg-cyan">Subject 2</th>
                                                <th class="bg-cyan">Subject 3</th>
                                                <th class="bg-success">Id no.</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        select</a> -->
                                                            <a href="./remove.php?id=<?php echo $row['id'] ?>" class="btn-sm btn btn-danger">
