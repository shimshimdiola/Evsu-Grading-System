...
<!-- modal -->
<?php include "./modal_student_first.php" ?><table id="example1" class="table table-bordered table-striped">
    <thead>
        <tr>
            <th>Name</th>
            <th>Subject</th>
    ...
    <tbody>
        ...
        $sql = "SELECT * FROM exam WHERE semester = 1 AND Subject = '$subject'";
