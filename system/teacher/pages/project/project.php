               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="../project/project.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Projects</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="../exam/exam.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Exam</p>
                                    </a>
                                </li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"> <span class="text-primary font-weight-bold text-uppercase"> <i class="fas fa-graduation-cap"></i> PROJECTS |
                                    <span class="text-sucess"> <?php echo  $_SESSION['subject'] ?></span></span></span>
                            </h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <div class="card-body">
                                    ...
                                    ?>
                                        <form action="" method="post">
                                            <div class="row ">
                                                <div class="col-12">
                                                    <input class="form-control mt-3 text-capitalize" type="text" name="" value="<?php echo $name  ?>" id="" readonly>



                                                </div>
                                                <div class="col-6">
                                                    <input class="form-control mt-3" type="text" name="" value="<?php echo $subject  ?>" id="" readonly>
                                                </div>
                                                <div class="col-6">
                                                    <input class="form-control mt-3" type="text" name="" value="<?php echo $date  ?>" id="" readonly>
                                                </div>
                                                <div class="col-6 mt-3">
                                                    <label for="">Items</label>
                                                    <input class="form-control " type="text" name="" value="<?php echo $item  ?>" id="" readonly>
                                                </div>
                                                <div class="col-6 mt-3">
                                                    <label for="">Score</label>
                                                    <input class="form-control " type="text" name="update_score" value="<?php echo $score  ?>" id="">
                                                </div>

                                            </div>
                                            <div class="d-flex justify-content-end mt-2">
                                                <a href="./project.php" class="btn btn-danger"> cancel</a>
                                                <button class="btn btn-success ml-3" type="submit" name="save"> <i class="fas fa-save"></i> save</button>
                                    ...
                                    <?php
                                        ...
                                        if (isset($_POST['save'])) {
                                            ...
                                            $sql = "UPDATE project SET score = ? WHERE id = ?";
                                        ...
                                        echo '   <p class="text-danger"> <i class=" fas fa-exclamation-triangle"></i> You need to
                            ...
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="pill" href="#first-semester" role="tab" aria-controls="custom-content-below-home" aria-selected="false"> <i class="fas fa-folder"></i> First
                                                Semester</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="pill" href="#second-semester" role="tab" aria-controls="custom-content-below-profile" aria-selected="false"> <i class="fas fa-folder"></i> Second
                                                Semester</a>
                                        </li>
