        ...
        <div class="modal-content">
            ...
            <form action="./send.php" method="post">
                <div class="modal-body">
                    <input type="text" value="1" name="semester" id="" hidden>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="subject" name="subject" value="<?php echo $_SESSION['subject'] ?>" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="submit" name="save_project_firstsem" class="btn btn-primary">Save changes</button>
                </div>
            </form>
