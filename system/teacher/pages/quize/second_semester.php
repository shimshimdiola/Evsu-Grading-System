...
<?php include "./modal_sudent_second.php" ?><table id="example2" class="table table-bordered table-striped">
    <thead>
        <tr>
            <th>Name</th>
            <th>Subject</th>
    ...
    <tbody>
        ...
        $sql = "SELECT * FROM quiz WHERE semester = 2 AND subject = '$subject'";
