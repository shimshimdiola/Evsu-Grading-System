               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="../quize/quize.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Quize</p>
                                    </a>
                                </li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"> <span class="text-primary font-weight-bold text-uppercase"> <i class="fas fa-graduation-cap"></i> QUIZZES |
                                    ...
                                    ?>
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="d-flex justify-content-end mt-2">
                                                <a href="./quize.php" class="btn btn-danger"> cancel</a> <button class="btn btn-success ml-3" type="submit" name="save"> <i class="fas fa-save"></i> save</button>
                                        ...
                                        if (isset($_POST['save'])) {
                                            ...
                                            $sql = "UPDATE quiz SET score = ? WHERE id = ?";
