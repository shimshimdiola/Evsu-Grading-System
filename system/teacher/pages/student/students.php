        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="../student/students.php" class="nav-link active">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"> <span class="text-primary text-uppercase font-weight-bold"> <i class="fas fa-graduation-cap"></i> STUDENTS |
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                class="mr-1 btn btn-sm btn-primary" type="submit"><i
                                                    class="fas fa-edit"></i> Edit</a href=""> -->

                                                <!-- <a href="./drop.php?id_number=<?php echo $row['id_number'] ?>"
                                                class="mr-1 btn btn-sm btn-danger"><i class="fas fa-trash-alt"></i>
                                                Delete / drop</a> -->
