        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"> <span class="text-primary text-uppercase font-weight-bold"> <i class="fas fa-graduation-cap"></i> GRADES |
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                <a class="btn btn-sm btn-primary" href="./evaluate.php?eval=true"><i class="fas fa-user-graduate"></i> eval
                                    1st-sem</a>
                                <a class="btn btn-sm btn-success" href="./evaluate.php?eval2=true"><i class="fas fa-user-graduate"></i> eval
                                    2nd-sem</a>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    // SQL query to fetch data with proper quoting
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            // You can access columns by name like $row['column_name']
                                            // echo "Subject ID: " . $row['id'] . ", Subject Name: " . $row['subject'] . "<br>";
