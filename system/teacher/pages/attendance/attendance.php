...
<body class="hold-transition sidebar-mini">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="../attendance/attendance.php" class="nav-link active">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">
                                <h1 class="m-0"> <span class="text-primary font-weight-bold text-uppercase"> <i class="fas fa-calendar"></i> ATTENDANCE |
                                    ...
                                    <div class="card-body">
                                        <table id="example3" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                $sql = "SELECT * FROM attendance WHERE subject = '$subject'";
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <input type="checkbox" value="present" id="checkboxSuccess"
                                                                checked disabled>
                                                            ...
                                                            <input type="checkbox" value="present" id="checkboxdanger"
                                                                checked disabled>
    ...
    <!-- AdminLTE App -->
    <script src="../../dist/js/alert.php"></script>
    ...
    <script>
        $(document).ready(function() {
            $('#present').click(function() {
                $('input[type="checkbox"][name="present"]').prop('checked',
                    this.checked);
            });
            $('#absent').click(function() {
                $('input[type="checkbox"][name="absent"]').prop('checked',
                    this.checked);
            });
        });
    </script>
