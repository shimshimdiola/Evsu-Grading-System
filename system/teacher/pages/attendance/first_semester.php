...
<table id="example1" class="table table-bordered table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td id="dateCell<?php echo $id; ?>"></td>
            <script>
            // Get the current date
            const currentDate_<?php echo $id; ?> = new Date();

            // Format the date as 'YYYY-MM-DD'
            const formattedDate_<?php echo $id; ?> = currentDate_<?php echo $id; ?>
                .toISOString().slice(0, 10);

            // Set the text content of the table cell to the current date
            document.getElementById('dateCell<?php echo $id; ?>').textContent =
                formattedDate_<?php echo $id; ?>;
            </script>
