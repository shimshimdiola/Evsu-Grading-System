...
<body class="hold-transition sidebar-mini">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="../activity/activity.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Activities</p>
                                    </a>
                                </li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"> <span class="text-primary font-weight-bold text-uppercase"> <i class="fas fa-graduation-cap"></i> ACTIVITIES |
                                    ...
                                    ?>
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="d-flex justify-content-end mt-2">
                                                <a href="./activity.php" class="btn btn-danger"> cancel</a> <button class="btn btn-success ml-3" type="submit" name="save"> <i class="fas fa-save"></i> save</button>
                                        ...
                                        if (isset($_POST['save'])) {
                                            ...
                                            $sql = "UPDATE activities SET score = ? WHERE id = ?";
    ...
    <script>
        $(function() {
            ...
            }).buttons().container().appendTo('#first_sem_wrapper .col-md-6:eq(0)');
            $("#second_sem").DataTable({
                "responsive": true,
                "lengthChange": false,
                "autoWidth": false,
                "buttons": ["copy", "csv", "excel", "pdf", "print"]
            }).buttons().container().appendTo('#second_sem_wrapper .col-md-6:eq(0)');
        });
    </script>
